 <div class="container-auth">
     <div class="row auth-wrapper">
         <form action="" class="validation" id="form-1">
             <div class="form-validation mt-2">
                 <div class="form-validation__header text-center d-flex justify-content-between align-items-center mb-5">
                     ...
                     <h5 class="form-validation__header-content fs-2 "><a href="http://localhost/Book-movie-tickets/alphacinemas.vn/register">Đăng kí</a></h5>
                 </div>
             </div>
             <div class="form-validation__body mt-2">
                 ...
                 <div class="mb-3">
                     ...
                     <button class="btn btn-success btn-lg fs-4">Đăng Nhập</button>
