    ...
    <div class="container-md main-content mb-5">
        <div class="row payment pt-5">
            <div class="col-md-8 pannelPayment">
                <div class="mb-5">
                    <h3 class="fs-1"><a class="primary-text" href="http://localhost/Book-movie-tickets/alphacinemas.vn/home" previewlistener="true">Trang chủ</a> &gt; <a class="primary-text" href="#">Đặt vé</a> &gt; <span><a class="primary-text" href="/chi-tiet-phim.htm?gf=722ed94a-ade3-488d-9845-8b7634cfd64a" previewlistener="true"><?php echo $currentMovie->title ?></a></span></h3>
                </div>
